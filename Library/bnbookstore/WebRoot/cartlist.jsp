	...
	<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
	    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        <td width="15" height="30"><img src="images/tab_03.gif" width="15" height="30" /></td>
	        <td width="1101" background="images/tab_05.gif"><img src="images/311.gif" width="16" height="16" /> <span class="STYLE4">我的购物篮</span></td>
	        <td width="281" background="images/tab_05.gif"><table border="0" align="right" cellpadding="0" cellspacing="0">
	          <tr>
	                    <td class="STYLE1"><div align="center"></div></td>
	                    <td class="STYLE1"><div align="center"></div></td>
									...
									<tr>
							            ...
							            <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1"><%=listcart.get(i).getNumber() %></div></td>
							          	<td height="18" bgcolor="#FFFFFF">
								          	<div align="center">
								          		<a href="javascript:void(0);" onclick="show(<%=listcart.get(i).getId() %>)"   >付款(总价:<%=df.format(Double.valueOf(listcart.get(i).getNumber()) *Double.valueOf(listbook.get(j).getPrices())) %>)</a><!-- cart?type=updatestate&id= -->
								          	</div>
							          	</td>
							        </tr>
								<%
