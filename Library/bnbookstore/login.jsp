          ...
          <tr>
            ...
            <td width="183" background="images/login_07.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
                <td height="30">&nbsp;</td>
                <td height="15"> 
                	<input type="submit" value="登录" style="height:20px; width:40px; border:solid 1px #cadcb2; font-size:12px; color:#81b432; cursor: pointer;">
                	<input type="reset" style="height:20px; width:40px; border:solid 1px #cadcb2; font-size:12px; color:#81b432; cursor: pointer;">
                	<a href="register.jsp"><input type="button" value="注册" style="height:20px; width:40px; border:solid 1px #cadcb2; font-size:12px; color:#81b432; cursor: pointer;"></a>
                </td>
              </tr>
            </table></td>
